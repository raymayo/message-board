...
const NoteCard = ({recipient,department,yearLevel,message,track}) => {
  return (
    <div className='bg-white border border-zinc-300 rounded-xl w-full h-60 flex flex-col justify-between shadow cursor-pointer hover:shadow-lg hover:scale-104 transition-all duration-300'>
